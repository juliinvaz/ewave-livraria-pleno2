...
{
    public class Quando_inativar_com_situacao_invalida
    {
        ...
        public Quando_inativar_com_situacao_invalida()
        {
        ...
        public void Quando_rodar_funcao()
        {
            ...
            action.Should().Throw<LivroSituacaoInvalidaParaInativarException>();
        }
    }
}
