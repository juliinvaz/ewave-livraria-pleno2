...
{
    public class Quando_criar_corretamente
    {
        ...
        public Quando_criar_corretamente()
        {
        ...
        {
            var action = new Action(() => _service.CriarAsync(_titulo, _genero, _autor, _sinopse, _capa).GetAwaiter().GetResult());
